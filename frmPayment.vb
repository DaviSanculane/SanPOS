    ...
    Private Sub txtCash_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCash.KeyPress
        If e.KeyChar = ControlChars.Cr Then
            ...
            If txtCash.Text = "" Then
                MsgBox("Please Enter Amount!/Porfavor Insira o Valor! ", MsgBoxStyle.Information, "Payment")
                txtCash.Focus()
                Exit Sub
            End If

            If Val(txtCash.Text) < Val(txtTA.Text) Then
                MsgBox("The Amount is Lower than the Cost/ Este Valor é menor do que o Custo", MsgBoxStyle.Exclamation, "Payment")
                txtCash.SelectAll()
                txtCash.Focus()
                Exit Sub
            End If
            ...
            frmPOS.AddPOS()
            AddPayment()
            MsgBox("printing receipt/ Imprimindo o Recibo...", MsgBoxStyle.Information, "Receipt")
